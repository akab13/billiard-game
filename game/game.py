...
pygame.display.set_caption("pool bash")
...
for imo in range(1,17):
    balls_img = pygame.image.load(f'assets/images/ball_{imo}.png').convert_alpha()
    balls_imgs.append(balls_img)
...
#new1_ball = create_ball(25,(600,300))
